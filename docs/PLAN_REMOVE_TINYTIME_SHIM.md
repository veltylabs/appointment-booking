# PLAN: Eliminar internal/tinytime — usar github.com/webtyp/time directamente

## Problema

El agente anterior cometió un error: en lugar de agregar las funciones faltantes
al paquete real `github.com/webtyp/time`, creó un subpaquete local
...
```
replace github.com/webtyp/time => ./internal/tinytime
```
...
en `github.com/webtyp/time` antes de ejecutar este plan.

Ver: `/home/cesar/Dev/Project/tinywasm/time/docs/PLAN.md`

Este plan asume que `github.com/webtyp/time v0.5.0` ya fue publicado.
...
```bash
go get github.com/webtyp/time@v0.5.0
go mod tidy
```
